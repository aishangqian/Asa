...
public class RightModel implements RightContract.IModel {
    Handler handler = new Handler();

    @Override
    public void getRight(HashMap<String, String> params, final ModelCallback modelCallback) {
        OkhttpUtils.getmInstance().doPost(UserApi.RIFHT_API, params, new OkhttpCallback() {
            @Override
