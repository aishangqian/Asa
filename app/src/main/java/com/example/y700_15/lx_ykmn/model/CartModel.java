...
public class CartModel implements CartContract.IModel {
    ...
    @Override
    public void getCarts(HashMap<String, String> params, final ModelCallback modelCallback) {
        OkhttpUtils.getmInstance().doPost(UserApi.SCART_URL, params, new OkhttpCallback() {
            @Override
